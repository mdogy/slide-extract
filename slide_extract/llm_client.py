...
class LLMClient:
    ...
    def generate_slide_analysis(self, slide_text: str, prompt: str, slide_number: int) -> str:
        """
    ...
    def _create_slide_prompt(self, slide_text: str, prompt: str, slide_number: int) -> str:
...
"""
    ...
    def test_connection(self) -> bool:
        ...
        try:
            response = self.generate_slide_analysis("Test slide content", test_prompt, 1)
